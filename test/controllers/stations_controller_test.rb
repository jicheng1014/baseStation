...
class StationsControllerTest < ActionController::TestCase
  ...
  test "should create station" do
    assert_difference('Station.count') do
      post :create, station: { description: @station.description, lat: @station.lat, lng: @station.lng, markup: @station.markup, name: @station.name }
    end
  ...
  test "should update station" do
    patch :update, id: @station, station: { description: @station.description, lat: @station.lat, lng: @station.lng, markup: @station.markup, name: @station.name }
    assert_redirected_to station_path(assigns(:station))
  end
